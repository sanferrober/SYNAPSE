...
function App() {
  ...
  const ActiveComponent = panels.find(panel => panel.id === activePanel)?.component || ConversationPanel;
    ...
    <SynapseProvider>
      <div className="h-screen bg-secondary-50 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-secondary-200 px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="hidden sm:flex p-2 text-secondary-600 hover:text-secondary-900 hover:bg-secondary-100 rounded-lg"
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Mobile Sidebar */}
          {!sidebarCollapsed && (
            <div className="md:hidden fixed inset-0 z-50 bg-black bg-opacity-50" onClick={() => setSidebarCollapsed(true)}>
